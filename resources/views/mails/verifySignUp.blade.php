...
<div class="container my-5 p-4 text-white rounded" style="max-width: 550px;">
   <img src="{{ asset('/') }}client/images/logo.webp" alt="background" class="position-absolute top-0 start-0 w-100 h-100" style="object-fit: cover; z-index: -1; filter: brightness(50%);">
