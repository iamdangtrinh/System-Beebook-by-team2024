...
<div style="max-width:800px;margin:0 auto;padding:20px;background-color:#f9f9f9;">
    <img src="{{ env('APP_URL') . '/logo_text.png' }}" style="width: 100%" alt="Bee book" title="Logo" />
    ...
    <div style="text-align: center; margin-top: 20px;">
        <a href="{{ route('product.index') }}"
            style="background-color: transparent; border: 1px solid #007bff; color: #007bff; padding: 10px 15px; text-decoration: none; border-radius: 5px; margin-right: 10px;">Xem đơn hàng</a>
