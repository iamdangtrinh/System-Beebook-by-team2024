...
<div style="max-width:800px;margin:0 auto;padding:20px;background-color:#f9f9f9;">
    ...
    <img src="https://beebook.site/client/images/logo.png" style="width: 100%" alt="Bee book" title="Logo" />
    ...
    <div style="text-align: center;">
        ...
        {{-- <p style="text-align: center; color: #555;">Tất cả thông tin cần thiết về việc giao hàng, chúng tôi đã gửi đến email của bạn.</p> --}}
        <p
            ...
            Mã đơn hàng : <b>{{ $resultBill->id }}</b></p>
        <p style="text-align: center; color: #555;">Thời gian đặt hàng:
            {{ date('H:i d-m-Y', strtotime($resultBill->created_at)) }}</p>
    </div>
    ...
    <div style="text-align: center; margin-top: 20px;">
        <a href="{{ route('product.index') }}"
            style="background-color: transparent; border: 1px solid #007bff; color: #007bff; padding: 10px 15px; text-decoration: none; border-radius: 5px; margin-right: 10px;">Xem
            đơn hàng</a>
        {{-- <a href="#" style="background-color: #dc3545; color: white; padding: 10px 15px; text-decoration: none; border-radius: 5px;">Mua lại</a> --}}
    </div>
</div>
