<title>@yield('title', 'Danh mục người dịch')</title>
            ...
            <div class="ibox-content m-b-sm border-bottom">
                <form action="{{ route('admintaxonomy.add') }}" method="post">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <button class="mt-3 btn btn-primary w-100">Thêm người dịch</button>
                        </div>
                    </div>
                </form>
            </div>
