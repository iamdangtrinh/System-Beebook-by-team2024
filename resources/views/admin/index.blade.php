...
<div id="overview" class="wrapper wrapper-content">
    ...
    <div class="row">
        ...
        <div class="col-lg-5">
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    <h5>Top 10 khách mua nhiều nhất</h5>

                    <select  style="border-color: #b6b6b6;border-radius: 5px;" name="" id="selectMonth" class="">
                        <option value="1">1 Tháng</option>
                        <option value="3">3 Tháng</option>
                        <option value="6">6 Tháng</option>
                        <option value="12">12 Tháng</option>
        ...
        const loadOnData = function() {
            $.ajax({
                ...
                success: function(response) {
                    ...
                    let DataCountOrder = {
                        grid: {
                            top: '10%', // Điều chỉnh khoảng cách từ trên xuống (giảm bớt khoảng trống)
                            bottom: '10%', // Điều chỉnh khoảng cách từ dưới lên (tùy chọn)
                            left: '5%',
                            right: '5%'
                        },
                        tooltip: {
