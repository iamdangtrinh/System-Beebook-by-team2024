            ...
            <div class="ibox float-e-margins">
                <div class="ibox-title">
                    ...
                    <div class="pull-right">
                        <div id="timeRangeButtonsOrders" class="btn-group">
            ...
            <div class="ibox float-e-margins">
                ...
                <div class="ibox-content">
                    <div class="mb-3">
                        ...
                        <select style="border-color: #b6b6b6;border-radius: 5px;" id="topSellingLimit" data-placeholder="Hiển thị" name="topSellingProducts">
