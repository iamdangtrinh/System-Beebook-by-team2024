...
@section('body')
    ...
    <div class="page-content">
        <div class="container-fluid">
            ...
            <form autocomplete="off" action="{{ route('adminblog.update') }}" enctype="multipart/form-data" method="POST">
                @csrf
                                        ...
                                        <div class="col-lg-3 col-xl-12 col-sm-6">
                                            <div class="mb-3">
                                                <label class="form-label" for="seo-description-input">Mô tả tiêu đề
                                                    seo</label>
                                                <textarea name="meta_description_seo" id="seo-description-input" cols="30" rows="10"
                                                    placeholder="Mô tả tiêu đề seo">
                                                    {{ $data->meta_description_seo }}
                                                </textarea>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="card-body">
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="choices-publish-status-input" name="status">
                                        <option value="active" {{ $data->status == 'active' ? 'selected' : '' }}>Hiện
                                        </option>
                                        <option value="inactive" {{ $data->status == 'inactive' ? 'selected' : '' }}>Ẩn
                                        </option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" name="hot" id="choice_title_hot">
                                        <option value="1" {{ $data->hot == 1 ? 'selected' : '' }}>Có</option>
                                        <option value="0" {{ $data->hot == 0 ? 'selected' : '' }}>Không</option>
                                    </select>
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <select name="post_type" class="form-control" id="post_type">
                                        <option value="blog" {{ $data->post_type == 'blog' ? 'selected' : '' }}>Bản tin
                                        </option>
                                        <option value="review" {{ $data->post_type == 'review' ? 'selected' : '' }}>Review
                                            sách</option>
                                    </select>
                                </div>
                                    ...
                                    <select name="id_product[]" multiple class="form-control setupSelect2" id="id_product">
                                        @foreach ($products as $product)
                                            <option value="{{ $product->id }}"
                                                @if (in_array($product->id, $postProduct->pluck('id_product')->toArray())) selected @endif>
                                                {{ $product->name }}
                                            </option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="mb-3">
                                    ...
                                    <span class="image img-cover image-target">
                                        <img src="{{ $data->image ?? '/no_image.jpg' }}" class="img-fluid rounded-top"
                                            alt="" />
                                    </span>
                                    <input type="hidden" value="{{ $data->image }}" name="image" class="url_image">
                                </div>
