                                ...
                                <div class="activity-stream">
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            <div class="stream-info">
                                                <a href="#">
                                                    <img src="{{asset('/')}}admin/img/a5.jpg" />
                                    ...
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            <div class="stream-info">
                                                <a href="#">
                                                    <img src="{{asset('/')}}admin/img/a4.jpg" />
                                    ...
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            <div class="stream-info">
                                                <a href="#">
                                                    <img src="{{asset('/')}}admin/img/a2.jpg" />
                                                    <img src="{{asset('/')}}admin/img/a3.jpg" />
                                                    <img src="{{asset('/')}}admin/img/a4.jpg" />
                                    ...
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            <div class="stream-info">
                                                <a href="#">
                                                    <img src="{{asset('/')}}admin/img/a6.jpg" />
                                    ...
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            <div class="stream-info">
                                                <a href="#">
                                                    <img src="{{asset('/')}}admin/img/a7.jpg" />
                                                    <img src="{{asset('/')}}admin/img/a1.jpg" />
                                    ...
                                    <div class="stream">
                                        ...
                                        <div class="stream-panel">
                                            <div class="stream-info">
                                                <a href="#">
                                                    <img src="{{asset('/')}}admin/img/a8.jpg" />
