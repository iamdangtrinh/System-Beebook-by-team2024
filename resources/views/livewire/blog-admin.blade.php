            ...
            <div class="row">
                <div class="col-sm-4 mb-3">
                    <div class="form-group">
                        <label class="control-label" for="order_id">Mã bài viết</label>
                ...
                <div class="col-sm-4 mb-3">
                    <div class="form-group">
                        <label class="control-label" for="status">Tên bài viết</label>
                        <input type="text" id="status" wire:model.live="title" value="" placeholder="Tên bài viết"
                            class="form-control">
                    </div>
                </div>
            </div>
