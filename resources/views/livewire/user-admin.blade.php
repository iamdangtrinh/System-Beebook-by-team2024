                            ...
                            <div class="d-flex flex-column gap-4">
                                ...
                                <form class="d-flex flex-column gap-4">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control rounded-3" name="name" placeholder="Họ tên" id="CustomerName" autocorrect="off" autocapitalize="off" autofocus value="{{old('name')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control rounded-3" name="phone" placeholder="Số điện thoại" id="CustomerPhone" autocorrect="off" autocapitalize="off" value="{{old('phone')}}">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input class="form-control rounded-3" name="email" placeholder="Email" id="CustomerEmail" autocorrect="off" autocapitalize="off" value="{{old('email')}}">
