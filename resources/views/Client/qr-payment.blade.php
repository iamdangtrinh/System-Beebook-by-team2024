            ...
            <div class="col-md-8 mx-auto">
                ...
                <div class="row mt-5" id="checkout_box">
                    <div class="col-md-6">
                        ...
                        <img src="https://qr.sepay.vn/img?bank=MBBank&acc=0362094527&template=compact&amount={{ intval($order_details->total_amount) }}&des=BEE)_{{ $order_details->id }}"
                            class="img-fluid">
                    </div>
                    <div class="col-md-6">
                        ...
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td>Nội dung CK:</td>
                                    <td><b>BEE_{{ $order_details->id }}</b></td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
