                                        ...
                                        <form action="{{ route('cart.store') }}" method="post">
                                            <div class="product-action">
                                                ...
                                                <div class="product-form__item--submit">
                                                    ...
                                                    <button type="submit" class="btn btn-addto-cart w-50 w-sm-100"
                    ...
                    @if ($product_same && $product_same->isNotEmpty())
                        <div class="related-product grid-products mt-3">
                            <header class="section-header">
                                ...
                                <p class="sub-heading">Có thể bạn quan tâm, dưới đây là các sách tương tự để bạn có thể dễ
                                    dàng
                                    chọn lựa.</p>
                            </header>
                                            ...
                                            <div class="product-price">
                                                ...
                                                @else
                                                    <span class="old-price">{{ number_format($pro->price, 0, ',', '.') }}
                                                        đ</span>
                                                    <span
                                                        class="price">{{ number_format($pro->price_sale, 0, ',', '.') }}
                                                        đ</span>
                                                @endif
                                            </div>
                                        </div>
