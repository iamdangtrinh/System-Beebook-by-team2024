                        ...
                        <div class="prFeatures">
                            <div class="row">
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 feature">
                                    <img src="{{ asset('/') }}client/images/icon_truck_v2.webp" alt="Safe Payment" title="Safe Payment" />
                                    <div class="details">
                                        <h3>Thời gian giao hàng</h3>Giao nhanh và uy tín.
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 feature">
                                    <img src="{{ asset('/') }}client/images/icon_transfer_v2.webp" alt="Confidence" title="Confidence" />
                                    <div class="details">
                                        <h3>Chính sách đổi trả</h3>Đổi trả miễn phí toàn quốc.
                                    </div>
                                </div>
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 feature">
                                    <img src="{{ asset('/') }}client/images/icon_shop_v2.webp" alt="Worldwide Delivery"
                                ...
                                <div class="col-12 col-sm-12 col-md-12 col-lg-12 feature">
                                    <img src="{{ asset('/') }}client/images/warranty.png" alt="Hotline" title="Hotline" />
                                    <div class="details">
                                ...
                                <div id="tab2" class="tab-content">
                                    <table>
                                        <tbody>
                                            ...
                                            <tr>
                                                <th>Nhà xuất bản</th>
                                                <td><a class="link-danger" href="{{ asset('nha-xuat-ban/' . $product->manufacturer->slug) }}">{{ $product->manufacturer->name }}</a></td>
                                            </tr>
                                            @endif
                                            @if ($product->author)
                                            <tr>
                                                <th>Tác giả</th>
                                                <td><a class="link-danger" href="{{ asset('tac-gia/' . $product->author->slug) }}">{{ $product->author->name }}</a></td>
                                            </tr>
                                            @endif
