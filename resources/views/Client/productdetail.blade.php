                ...
                <div class="bredcrumbWrap">
                    <div class="container breadcrumbs">
                        <a href="index.html" title="Back to the home page">Home</a><span
                            aria-hidden="true">›</span><span>Product Layout Style2</span>
                    </div>
                </div>
                <!--End Breadcrumb-->
                                ...
                                <div class="product-details-img product-single__photos bottom">
                                    ...
                                    <div class="product-thumb product-thumb-1">
                                        <div id="gallery" class="product-dec-slider-1 product-tab-left">
                                            ...
                                            @foreach($product_meta)
                                            if($product_meta->product_key=="thumbnail")
                                            <a data-image="assets/images/product-detail-page/cape-dress-2.jpg"
                                                data-zoom-image="assets/images/product-detail-page/cape-dress-2.jpg"
                                                class="slick-slide slick-cloned" data-slick-index="-3"
                                                aria-hidden="true" tabindex="-1">
                                                <img class="blur-up lazyload"
                                                    src="assets/images/product-detail-page/cape-dress-2.jpg" alt="" />
                                            </a>
                                            @endif
                                            @endforeach
                                        </div>
                                        ...
                                        <div class="swatch clearfix swatch-1 option2" data-option-index="1">
                                            <div class="product-form__item">
                                                ...
                                                <div data-value="X-Small" class="swatch-element x-small available">
                                                    <input class="swatchInput" id="swatch-1-x-small" type="radio"
                                                        name="option-1" value="X-Small"><label
                                                        class="swatchLbl small rounded" for="swatch-1-x-small"
