                    ...
                    <div class="row gutter">
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered" style="white-space: nowrap;">
                                    <thead class="cart__row cart__header">
                                        <tr>
                                            <th class="text-center d-none"><input type="checkbox" name="checkAll" id="checkAll"></th>
                                                ...
                                                <td class="cart__update-wrapper cart-flex-item text-center">
                                                    <div class="cart__qty text-center">
                                                        <div class="qtyField">
                                                            ...
                                                            <input class="cart__qty-input qty" type="text" name="quantity[]" id="qty" value="{{ $quantity }}">
                        ...
                        <div class="col-12 col-sm-12 col-md-3 col-lg-3 main-col">
                            <div class="solid-border mt-3">
                                ...
                                <button name="checkout" id="cartCheckout" class="btn btn--small-wide checkout"
                                    value="checkout">Thanh toán</button>
