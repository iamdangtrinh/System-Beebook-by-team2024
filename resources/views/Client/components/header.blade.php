                                    ...
                                    <div class="megamenu style4">
                                        <ul class="grid grid--uniform mmWrapper">
                                            ...
                                            <li class="grid__item lvl-1 col-md-6 col-lg-6">
                                                <a href="#"><img
                                                        src="{{ asset('/') }}client/images/megamenu-bg1.jpg"
                                                        alt="" title="" /></a>
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="megamenu style2">
                                        <ul class="grid mmWrapper">
                                            ...
                                            <li class="grid__item large-up--one-whole imageCol"><a href="#"><img
                                                        src="{{ asset('/') }}client/images/megamenu-bg2.jpg"
                                                        alt=""></a></li>
                                        </ul>
                                    </div>
                                </li>
                                ...
                                <ul class="mini-products-list">
                                    <li class="item">
                                        <a class="product-image" href="#">
                                            <img src="{{ asset('/') }}client/images/product-images/cape-dress-1.jpg"
                                    ...
                                    <li class="item">
                                        <a class="product-image" href="#">
                                            <img src="{{ asset('/') }}client/images/product-images/cape-dress-2.jpg"
