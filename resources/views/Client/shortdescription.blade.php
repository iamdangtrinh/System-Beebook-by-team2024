                            ...
                            <div class="product-details-img">
                                <div class="product-thumb">
                                    <div id="gallery" class="product-dec-slider-2 product-tab-left">
                                        <a data-image="{{asset('/')}}client/images/product-detail-page/cape-dress-1.jpg" data-zoom-image="{{asset('/')}}client/images/product-detail-page/cape-dress-1.jpg" class="slick-slide slick-cloned" data-slick-index="-4" aria-hidden="true" tabindex="-1">
                                            <img class="blur-up lazyload" src="{{asset('/')}}client/images/product-detail-page/cape-dress-1.jpg" alt="" />
                                        </a>
                                        <a data-image="{{asset('/')}}client/images/product-detail-page/cape-dress-2.jpg" data-zoom-image="{{asset('/')}}client/images/product-detail-page/cape-dress-2.jpg" class="slick-slide slick-cloned" data-slick-index="-3" aria-hidden="true" tabindex="-1">
                                            <img class="blur-up lazyload" src="{{asset('/')}}client/images/product-detail-page/cape-dress-2.jpg" alt="" />
                                        </a>
                                        <a data-image="{{asset('/')}}client/images/product-detail-page/cape-dress-3.jpg" data-zoom-image="{{asset('/')}}client/images/product-detail-page/cape-dress-3.jpg" class="slick-slide slick-cloned" data-slick-index="-2" aria-hidden="true" tabindex="-1">
                                            <img class="blur-up lazyload" src="{{asset('/')}}client/images/product-detail-page/cape-dress-3.jpg" alt="" />
                                        </a>
                                        <a data-image="{{asset('/')}}client/images/product-detail-page/cape-dress-4.jpg" data-zoom-image="{{asset('/')}}client/images/product-detail-page/cape-dress-4.jpg" class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1">
                                            <img class="blur-up lazyload" src="{{asset('/')}}client/images/product-detail-page/cape-dress-4.jpg" alt="" />
                                        </a>
                                        <a data-image="{{asset('/')}}client/images/product-detail-page/cape-dress-5.jpg" data-zoom-image="{{asset('/')}}client/images/product-detail-page/cape-dress-5.jpg" class="slick-slide slick-cloned" data-slick-index="0" aria-hidden="true" tabindex="-1">
                                            <img class="blur-up lazyload" src="{{asset('/')}}client/images/product-detail-page/cape-dress-5.jpg" alt="" />
                                        </a>
                                        <a data-image="{{asset('/')}}client/images/product-detail-page/cape-dress-6.jpg" data-zoom-image="{{asset('/')}}client/images/product-detail-page/cape-dress-6.jpg" class="slick-slide slick-cloned" data-slick-index="1" aria-hidden="true" tabindex="-1">
                                            <img class="blur-up lazyload" src="{{asset('/')}}client/images/product-detail-page/cape-dress-6.jpg" alt="" />
                                        </a>
                                        <a data-image="{{asset('/')}}client/images/product-detail-page/cape-dress-7.jpg" data-zoom-image="{{asset('/')}}client/images/product-detail-page/cape-dress-7.jpg" class="slick-slide slick-cloned" data-slick-index="2" aria-hidden="true" tabindex="-1">
                                            <img class="blur-up lazyload" src="{{asset('/')}}client/images/product-detail-page/cape-dress-7.jpg" alt="" />
                                        </a>
                                    </div>
                                </div>
                                <div class="zoompro-wrap product-zoom-right pl-20">
                                    <div class="zoompro-span">
                                        <img class="zoompro blur-up lazyload" data-zoom-image="{{asset('/')}}client/images/product-detail-page/cape-dress-1.jpg" alt="" src="{{asset('/')}}client/images/product-detail-page/cape-dress-1.jpg" />
                                    </div>
                                ...
                                <div class="lightboximages">
                                    <a href="{{asset('/')}}client/images/product-detail-page/cape-dress-1.jpg" data-size="1462x2048"></a>
                                    <a href="{{asset('/')}}client/images/product-detail-page/cape-dress-2.jpg" data-size="1462x2048"></a>
                                    <a href="{{asset('/')}}client/images/product-detail-page/cape-dress-3.jpg" data-size="1462x2048"></a>
                                    <a href="{{asset('/')}}client/images/product-detail-page/cape-dress-4.jpg" data-size="1462x2048"></a>
                                    <a href="{{asset('/')}}client/images/product-detail-page/cape-dress-5.jpg" data-size="1462x2048"></a>
                                    <a href="{{asset('/')}}client/images/product-detail-page/cape-dress-6.jpg" data-size="1462x2048"></a>
                                    <a href="{{asset('/')}}client/images/product-detail-page/cape-dress-7.jpg" data-size="731x1024"></a>
                                </div>
