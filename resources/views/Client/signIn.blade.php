                    ...
                    <form class="d-flex flex-column gap-3" action="" method="post">
                        ...
                        <div class="col-12 position-relative">
                            <div class="form-group">
                                ...
                                <input class="rounded-1" type="email" name="email" placeholder="Email" id="CustomerEmail" autocorrect="off" autocapitalize="off" autofocus="">
                                @error('email')
                        ...
                        <div class="col-12">
                            <div class="form-group position-relative">
                                ...
                                <input class="rounded-1" type="password" name="password" placeholder="Mật khẩu" id="CustomerPassword">
                                @error('password')
                                <span class="text-danger">{{$message}}</span>
                                @enderror
                            </div>
                        ...
                        {{-- Nút Đăng Nhập --}}
                        <button style="background: black !important" type="submit" class="btn border-0 pt-3 pb-3 rounded-1 fs-6">Đăng Nhập</button>
                    </form>
                    <div class="d-flex gap-1 justify-content-center">
                        <p>Bạn chưa có tài khoản?</p>
                        <a href="/sign_up" class="text-primary">Đăng Ký</a>
                    </div>
                </div>
            </div>
        </div>
